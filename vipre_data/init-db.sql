...
CREATE TABLE trajectory (
    ...
    pos_sc_arr_y FLOAT, 
    pos_sc_arr_z FLOAT, 
    pos_target_arr_x FLOAT, 
    pos_target_arr_y FLOAT, 
    pos_target_arr_z FLOAT, 
    PRIMARY KEY (id), 
...
CREATE TABLE entry (
    ...
    pos_earth_entry_x FLOAT, 
    pos_earth_entry_y FLOAT, 
    pos_earth_entry_z FLOAT, 
...
INSERT INTO alembic_version (version_num) VALUES ('2e9686bf76a3');
